...
| Apple SpeechTranscriber | On-device on supported macOS 26 and iOS 26 hardware |
...
| Flutter iOS app and keyboard | Local WhisperKit/Core ML or Apple SpeechTranscriber, setup, model packs, local history, modes, punctuation, haptics, and text-field workflows. |
